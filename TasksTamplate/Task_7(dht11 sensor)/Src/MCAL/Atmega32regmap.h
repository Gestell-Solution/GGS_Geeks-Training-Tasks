 ...
 */
/**
 * @def ATMEGA32REGMAP_H_
 * @brief Definition for ATMEGA32REGMAP_H_.
 */
#define ATMEGA32REGMAP_H_

#include <stdint.h>

/**
 * @def SREG_Reg
 * @brief Memory-mapped register definition for SREG_Reg.
 */
