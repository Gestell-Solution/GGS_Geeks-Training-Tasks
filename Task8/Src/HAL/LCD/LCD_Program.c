...
void LCD_Init (uint8_t ModeType)
{
    ...
    {
        DIO_InitGroup(Lcd_DataGroup, 0xF0);
        _delay_ms(35);
        LCD_WriteInstruction(0x02, Lcd_4bitMode);
        _delay_ms(1);
        LCD_WriteInstruction(Lcd_4bitMode2Line5x8F, Lcd_4bitMode);
        _delay_ms(1);
        LCD_WriteInstruction(Lcd_CursorOn, Lcd_4bitMode);
        _delay_ms(1);
...
{
LCD_WriteData(Number+'0',Lcd_8bitMode);
}